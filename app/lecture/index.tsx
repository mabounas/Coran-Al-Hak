...
export default function ReadSummaryScreen() {
    ...
    <View style={[styles.container, dark && styles.containerDark]}>
      <View style={styles.searchWrap}>
        <View style={[styles.topRow, isRTL && styles.topRowRTL]}>
          <Text style={[styles.subtitle, dark && styles.mutedDark]}>{t('read.subtitle')}</Text>
          <TouchableOpacity
      ...
      <FlatList
        ...
        renderItem={({ item }) => <SurahReadCard surah={item} />}
